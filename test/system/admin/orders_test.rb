...
class Admin::OrdersTest < ApplicationSystemTestCase
  ...
  test "should create order" do
    ...
    fill_in "Customer first name", with: @admin_order.customer_first_name
    fill_in "Customer last name", with: @admin_order.customer_last_name
    check "Fulfilled" if @admin_order.fulfilled
    fill_in "Quantity", with: @admin_order.quantity
